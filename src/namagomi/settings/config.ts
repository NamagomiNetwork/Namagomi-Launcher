...
export const namagomiFileUrlBase = (path: string) => 'https://raw.githubusercontent.com/NamagomiNetwork/Namagomi-mod/main/' + path
export const namagomiConfigFileUrlBase = (file: string) => namagomiFileUrlBase(path.join('config', file))